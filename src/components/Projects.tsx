    ...
    return (
        <section className="data-editor" data-active={displayActive} data-complete={isComplete}>
            <button className="data-expand-btn" onClick={() => setDisplayActive(!displayActive)}>
                <h3>{details.project? details.project: 'No project title'}</h3>
            ...
            <div className="data-inputs">
                ...
                <button className="delete-data-btn" onClick={() => handleDelete(deleteDetails)}>
...
export function ProjectEditSection({ projectDetails, handleChange, addData, handleDelete }: ProjectEditSectionProps) {
    ...
    return (
        <section className="data-editor-section" data-active={displayActive}>
            <button className="data-expand-btn" onClick={() => setDisplayActive(!displayActive)}>
                <svg className="section-icon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 360.844 360.844" xmlSpace="preserve">
                  <g id="XMLID_71_">
